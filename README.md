...
### Installing Vue Storefront
	...
	oc create configmap vue-storefront --from-file=config/local.json --from-file=config/default.json --from-file=config/test.json --from-file=config/custom-environment-variables.json
